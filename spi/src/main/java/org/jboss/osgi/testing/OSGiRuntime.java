...
public interface OSGiRuntime {
     ...
     * 
     * Adding a capability recursively adds the orderded set of dependent capabilities before it installs and starts the
     * orderded set bundles.
     */
     ...
     * 
     * In case the version is left unspecified, it returns the first bundle that matches the symbolic name.
     * 
